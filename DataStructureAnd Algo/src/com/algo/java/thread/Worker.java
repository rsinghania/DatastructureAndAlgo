...
public class Worker {
	...
	public void doWork() {
		...
		/**
		 * Join Threads: Finish until thread finishes execution, then progress the code
		 * Reminder: your method is also a thread so without joining threads
		 * System.out.println("Count is: " + count); will work immediately. Join does
		 * not terminate Thread 2, just progress of the code stops until Threads
		 * terminate.
		 */
		try {
			thread1.join();
